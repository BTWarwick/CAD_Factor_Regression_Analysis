...
For comparative purposes, the file US_listed_US_Equity replicates the results from portfoliovisualizer.com for US listed US Equities 
analyzed using the FF 5-factor model with daily data.

X, Custom_start_date, and Custom_end_date can be modified as required by the user. If the user does not wish to enter a custom start
or end date, a value of zero will use the longest dataset possible.
...
CDN_Factor_Regression.py contains the functions CDN_Listed_CDN_Equity, CDN_Listed_US_Equity, and US_Listed_US_Equity if the user prefers to have 
